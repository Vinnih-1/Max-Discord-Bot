...
public class UnbanButtonInteraction extends InteractionService<ButtonInteractionEvent> {

    public UnbanButtonInteraction() {
        super("button-unban");
    }
    ...
    public void execute(ButtonInteractionEvent event) {
        ...
        modal.addActionRow(TextInput.create("unban", "Name", TextInputStyle.SHORT)
