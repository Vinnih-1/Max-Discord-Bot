...
@ConfigSection("menu")
@ConfigFile("menu.yml")
public class ServiceMenuValue implements ConfigurationInjectable {

    @Getter private static final ServiceMenuValue instance = new ServiceMenuValue();

    @ConfigField("services") private ConfigurationSection section;
    ...
    public static <T> T get(Function<ServiceMenuValue, T> function) {
