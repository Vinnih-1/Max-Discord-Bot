...
@ConfigSection("menu")
@ConfigFile("menu.yml")
public class UnbanMenuValue implements ConfigurationInjectable {

    @Getter private static final UnbanMenuValue instance = new UnbanMenuValue();

    @ConfigField("unban") private ConfigurationSection section;
    ...
    public static <T> T get(Function<UnbanMenuValue, T> function) {
