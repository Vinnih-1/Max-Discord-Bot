...
@ConfigSection("embed.unban")
@ConfigFile("embed.yml")
public class UnbanEmbedValue implements ConfigurationInjectable {

    @Getter private static final UnbanEmbedValue instance = new UnbanEmbedValue();
    ...
    public static <T> T get(Function<UnbanEmbedValue, T> function) {
