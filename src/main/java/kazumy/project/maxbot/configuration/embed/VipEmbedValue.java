...
@ConfigSection("embed.vip")
@ConfigFile("embed.yml")
public class VipEmbedValue implements ConfigurationInjectable {

    @Getter private static final VipEmbedValue instance = new VipEmbedValue();
    ...
    public static <T> T get(Function<VipEmbedValue, T> function) {
