...
@ConfigSection("embed.cash")
@ConfigFile("embed.yml")
public class CashEmbedValue implements ConfigurationInjectable {

    @Getter private static final CashEmbedValue instance = new CashEmbedValue();
    ...
    public static <T> T get(Function<CashEmbedValue, T> function) {
