...
@ConfigSection("embed.nickname")
@ConfigFile("embed.yml")
public class NicknameEmbedValue implements ConfigurationInjectable {

    @Getter private static final NicknameEmbedValue instance = new NicknameEmbedValue();
    ...
    public static <T> T get(Function<NicknameEmbedValue, T> function) {
