...
@ConfigSection("embed.terms")
@ConfigFile("embed.yml")
public class TermsEmbedValue implements ConfigurationInjectable {

    @Getter private static final TermsEmbedValue instance = new TermsEmbedValue();
    ...
    @ConfigField("image") private String image;
    ...
    public static <T> T get(Function<TermsEmbedValue, T> function) {
