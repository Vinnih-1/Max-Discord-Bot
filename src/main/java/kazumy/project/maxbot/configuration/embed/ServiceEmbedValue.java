...
@ConfigSection("embed.services")
@ConfigFile("embed.yml")
public class ServiceEmbedValue implements ConfigurationInjectable {

    @Getter public static final ServiceEmbedValue instance = new ServiceEmbedValue();
    ...
    public static <T> T get(Function<ServiceEmbedValue, T> function) {
